export const projects = {
    ...
    "coca-project-v1": {
        ...
        live: "#",
        images: [
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_1.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_2.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_3.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_4.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_5.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_6.webp`,
        ],
        longDescription:
    ...
    "Pokits-project": {
        ...
        live: "#",
        images: [
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠1.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠2.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠3.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠4.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠5.webp`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠6.webp`,
        ],
        longDescription:
