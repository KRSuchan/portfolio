export const projects = {
    ...
    "coca-project-v1": {
        ...
        live: "#",
        images: [
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_1.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_2.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_3.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_4.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_5.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/코카1/코카1_6.png`,
        ],
        longDescription:
    ...
    "Pokits-project": {
        ...
        live: "#",
        images: [
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠1.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠2.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠3.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠4.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠5.png`,
            `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/포킷츠/포킷츠6.png`,
        ],
        longDescription:
